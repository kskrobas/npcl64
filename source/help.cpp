...
print("comment - put a comment into header");
...
print("geometry poly <value>{1+2+3} - select supersphere polyhedral shape of grain for parametrs: p, a, b and elongation along x, y, z axes. It works for hcp only");
