...
auto atomChargeStyle=(lmpstyle=="atomcharge")
            ...
            for(i=1;i<=numOfatomsTot;i++,ptr_atom++){
                file<<setw(6)<<i<<"  "<<( ptr_atom->atype+1 )<<"  "<<  atomChargeStyle(ptr_atom->atype)
...
const size_t row_size=100;
            ...
            strLine.reserve(row_size);
            strHeader.reserve(row_size*10);
...
auto atomChargeStyle=(lmpstyle=="atomcharge")
            ...
            for(size_t i=1;i<=nOfatoms;i++,ptr_atom++){
                strLine=std::to_string(i)+"  "+
                        std::to_string( ptr_atom->atype+1 )+"  "+
...
const StAtom * ptr_atom=atoms.data();
            ...
            /// 3, 4, 5 row:  box size
            file<<setw(20)<<std::right<<(minmax.width+2*mX)<<setw(20)<<std::right<<0<<setw(20)<<std::right<<0<<endl;
            file<<setw(20)<<std::right<<0<<setw(20)<<std::right<<(minmax.length+2*mY)<<setw(20)<<std::right<<0<<endl;
            file<<setw(20)<<std::right<<0<<setw(20)<<std::right<<0<<setw(20)<<std::right<<(minmax.height+2*mZ)<<endl;
